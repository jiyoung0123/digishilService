...
public class RoomService implements KBService<Integer, Room> {
    ...
    public Page<Room> getPage2(int pageNo, String s) throws Exception {
        PageHelper.startPage(pageNo,6); // 3: 한화면에 출력되는 개수
        return mapper.getpage2(s);
    }
    ...
    public Page<Room> roomSearch2(int pageNo, RoomSearch rs, String s) throws Exception {
        PageHelper.startPage(pageNo, 6);
        return mapper.roomSearch2(rs, s);
    }
