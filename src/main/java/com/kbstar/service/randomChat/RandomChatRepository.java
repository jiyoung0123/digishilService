...
@Repository
@Slf4j
public class RandomChatRepository {

    private Map<String, RandomChatRoom> chatRoomMap;
    ...
    // roomName 로 채팅방 만들기
    public RandomChatRoom createChatRoom(String roomName){
        RandomChatRoom chatRoom = new RandomChatRoom().create(roomName); // 채팅룸 이름으로 채팅 룸 생성 후
