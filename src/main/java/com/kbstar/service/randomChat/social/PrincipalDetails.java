package com.kbstar.service.randomChat.social;

import com.kbstar.dto.RandomChatUser;
import lombok.Data;
...
public class PrincipalDetails implements UserDetails, OAuth2User {
    ...
    // 일반 유저
    public PrincipalDetails(RandomChatUser user, String provider) {
        this.user = user;
        this.provider = provider;
    }

    // OAuth2User 유저 -> 소셜 로그인 유저
    public PrincipalDetails(RandomChatUser user, Map<String, Object> attributes, String provider){
        this.user = user;
